...
async def nba_analysis_exists(
    ...
    *,
    ...
    return bool(
        await conn.fetchval(
            NBA_ANALYSIS_EXISTS, game_time, game_tag, player_id, stat, line
        )
    )
...
async def nba_upsert_analysis(
    ...
    *,
    ...
    r = await conn.fetchval(NBA_UPSERT_ANALYSIS, analysis, price, game_time, game_tag)
    return int(r or 0)
